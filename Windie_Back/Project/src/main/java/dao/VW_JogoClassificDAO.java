...
public class VW_JogoClassificDAO {
	...
	public List<VW_JogoClassificModelo> getListaPagina(Ordenacoes ordem, int itens_por_pagina, int pagina, String termo_busca) throws SQLException { //pega uma lista com um numero dado de itens em uma determinada posição determinada pela pagina, também pode filtrar a busca usando um termo
