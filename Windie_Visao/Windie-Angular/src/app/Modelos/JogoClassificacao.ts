...
export class JogoClassificacao {
    ...
    constructor(
      ...
      public horas_jogadas : number
    ) { 
      //this.Init(null,null);
    }

    public static Init(genero_string: string | null, screenshots: any[] | null, jogo : JogoClassificacao,sanitizer: DomSanitizer){
